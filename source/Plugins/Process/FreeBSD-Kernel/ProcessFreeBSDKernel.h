...
class ProcessFreeBSDKernel : public lldb_private::Process
{
public:
    //------------------------------------------------------------------
    ...
    lldb::addr_t
    LookUpSymbolAddressInModule(lldb::ModuleSP  module, const char *sym_name);
...
protected:
    ...
    ThreadFreeBSDKernel *
    CreateNewThreadFreeBSDKernel(lldb_private::Process &process, lldb::tid_t tid);
    ...
    void
    AddProcs(uintptr_t paddr);

    lldb::addr_t
    FindCorePCB(uint32_t cpuid);
